...
const Loader = () => {
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-999 overflow-hidden bg-gray-800 opacity-75 flex flex-row items-center justify-center">
      <div
        key="1-dot"
